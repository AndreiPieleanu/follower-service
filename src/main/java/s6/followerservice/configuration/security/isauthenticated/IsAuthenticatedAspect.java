package s6.followerservice.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(s6.followerservice.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(s6.followerservice.configuration.security.isauthenticated.IsAuthenticated)")
